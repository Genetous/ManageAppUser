...
export const Methods = {
    ...
    GetIndex:rule_engine + '/get/index',
    GetSQLQuery:rule_engine + '/get/sql',
    SetSQLQuery:rule_engine + '/add/sql',
    DelSQLQuery:rule_engine + '/delete/sql',
    GetCypherQuery:rule_engine + '/get/cypher',
    SetCypherQuery:rule_engine + '/add/cypher',
    DeleteCypherQuery:rule_engine + '/delete/cypher',
    GetGCQuery:rule_engine + '/get/gc',
    SetGCQuery:rule_engine + '/add/gc',
    DeleteGCQuery:rule_engine + '/delete/gc',
    GetRedisQuery:rule_engine + '/get/redis',
    SetRedisQuery:rule_engine + '/add/redis',
    DelRedisQuery:rule_engine + '/delete/redis',
