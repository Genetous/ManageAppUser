...
export class ExecuteGC extends Component {
    constructor(props) {
        super(props);
        this.state = {
            executeRules: [],
            selectedQuery: { indexName: "", gc: "", permitted: [], functionName: "" },
            functionNames: ["addCollection", "addUniqueCollection", "addMultiCollection", "addRelation"
                , "getCollection", "getRelation", "updateCollection", "deleteCollection", "isUnique", "createUpdateLink",
                "updateWithKey"],
            newIndex: true,
            activeKey: 1,
        ...
        return <CCard className='mt-2'>
            ...
            <CCardBody>
                ...
                <CRow className='mt-2 pb-2'>
                    <CCol>
                        <CFormTextarea value={this.state.selectedQuery.gc}
                            name='gc'
                            onChange={this.changedValues.bind(this)}
                            placeholder='Insert your Genetous JSON command'
                        ></CFormTextarea>
                    </CCol>
                </CRow>
    ...
    getFormNew() {
        return <CCard className='mt-2'>
            <CCardBody>
                ...
                <CRow className='mt-2 pb-2'>
                    <CCol>
                        <CFormTextarea name='gc' value={this.state.selectedQuery.gc}
                            placeholder='Insert your Genetous JSON'
                            onChange={this.changedValues.bind(this)}
                        ></CFormTextarea>
                    </CCol>
                </CRow>
    ...
    async updateIndex() {
        ...
        var model = {
            ...
            gc: this.state.selectedQuery.gc,
    ...
    createNew() {
        ...
        element.value = "0";
        var empty = { indexName: "", gc: "", permitted: [], functionName: "" }
            ...
            <CCard>
                ...
                <CRow className='m-2 border-bottom d-flex align-items-center'>
                    <CCol className='col-6 pb-2'>
                        <CCardTitle>Add/Update <b>"Execute Genetous"</b> Permissions</CCardTitle>
                    </CCol>
